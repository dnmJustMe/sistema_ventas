...
class RepositorioServicio
{
	...
	{
		return RepositorioImagen::obtener_imagenes_por_servicio($conexion, $servicio_id);
	}

	public static function obtener_imagen_principal_servicio($conexion, $servicio_id)
	{
		return RepositorioImagen::obtener_imagen_principal_por_entidad($conexion, 'servicio', $servicio_id);
	}

	public static function agregar_imagen_a_servicio($conexion, $servicio_id, $path, $es_principal = 0)
	{
		$imagen = new Imagen(null, null, null, $servicio_id, $path, null, $es_principal);
	...
	{
		return RepositorioImagen::eliminar_imagenes_por_servicio($conexion, $servicio_id);
	}
}
