    ...
    <div class="dashboard-container">
        <main class="dashboard-content">
            <div class="content-header">
                ...
                <p>Administra los servicios del catálogo</p>
            </div>

            <!-- Barra de herramientas -->
            <div class="toolbar">
                <button class="btn btn-primary" id="btn-agregar-servicio">
...
<div class="modal fade" id="modal-servicio" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalServicioLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modalServicioLabel">Agregar Servicio</h1>
            ...
            <form id="form-servicio">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="servicio-nombre" name="nombre" required>
                    </div>

                    <div class="form-group mb-3">
                        <label for="servicio-descripcion" class="form-label">Descripción</label>
                        <textarea class="form-control" id="servicio-descripcion" name="descripcion" rows="3"></textarea>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="file" id="servicio-imagen-principal" name="imagen_principal_file" accept="image/*" style="display: none;">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="file" id="servicio-imagenes" name="imagenes[]" accept="image/*" multiple style="display: none;">
                        <div class="imagenes-existente" id="imagenes-extras-existente"></div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                    <button type="submit" class="btn btn-primary" id="guardar-servicio">Guardar</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="modal-detalles-servicio" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalDetallesLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modalDetallesLabel">Detalles del Servicio</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
...
<script src="<?php echo RUTA_JS ?>servicios.js"></script>
<?php
